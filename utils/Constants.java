...
public final class Constants {
    ...
    // GoodBoy Constants
    public static final int GOOD_BOY_KNIGHT_HEAL = 20;
    public static final int GOOD_BOY_PYRO_HEAL = 30;
    public static final int GOOD_BOY_ROGUE_HEAL = 40;
    public static final int GOOD_BOY_WIZARD_HEAL = 50;
    ...
    // LifeGiver Constants
    public static final int LIFE_GIVER_KNIGHT_HEAL = 100;
    public static final int LIFE_GIVER_PYRO_HEAL = 80;
    public static final int LIFE_GIVER_ROGUE_HEAL = 90;
    public static final int LIFE_GIVER_WIZARD_HEAL = 120;
    // SmallAngel Constants
    public static final int SMALL_ANGEL_KNIGHT_HEAL = 10;
    public static final int SMALL_ANGEL_PYRO_HEAL = 15;
    public static final int SMALL_ANGEL_ROGUE_HEAL = 20;
    public static final int SMALL_ANGEL_WIZARD_HEAL = 25;
