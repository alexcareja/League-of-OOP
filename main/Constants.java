...
public final class Constants {
    ...
    static final int WIN_EXPERIENCE = 200;
    ...
    static final float DRAIN_MAX_HEALTH_MULT = 0.3f;
    ...
    static final int BACKSTAB_CRIT_COUNT = 3;
    static final float BACKSTAB_CRIT_MULTIPLIER = 1.5f;
